using Robworld.ProcessSimulate.Library.CommandEnablers;
...
namespace Robworld.ProcessSimulate.CECommands
{
    ...
    public class OpenMDDCommand : TxButtonCommand
    {
        ...
        /// </summary>
        public override string Bitmap => "Images.OpenMDD16x16.bmp";

        /// <summary>
        /// Get the 32x32 bitmap of the command
        /// </summary>
        public override string LargeBitmap => "Images.OpenMDD32x32.png";
